"""
tasks.py — Automated background task runner for Goalwire.
Handles live event loops, match hub edits, breaking transfer news, and user alerts.
"""
...
class GoalwireTasks(commands.Cog):
    ...
    async def transfer_news_loop(self):
        ...
        try:
            ...
            transfer_date = move["date"]            # Must be indented
            m_type = move["type"] or "Permanent Deal" # Must be indented
            teams = move["teams"]                  # Must be indented
